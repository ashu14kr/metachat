...
import 'package:metachat/screens/media/video_player2.dart';
import 'package:metachat/screens/media/video_view.dart';

import '../../constant.dart';
import '../../controllers/media.dart';
...
class AddVideoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              onSelected: (value) {
                if (value == 1) {
                  commonController
                      ...
                      .whenComplete(() {
                    if (commonController.vidpick.value) {
                      var video = commonController.video.value;
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  VideoViewScreen(vid: video)));
                    } else {
                      return;
                    }
                  });
                  ...
                  commonController
                      ...
                      .whenComplete(() {
                    if (commonController.vidpick.value) {
                      var video2 = commonController.video.value;
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  VideoViewScreen(vid: video2)));
                    } else {
                      return;
                    }
                  });
        ...
        body: FutureBuilder(
            future: mediaController.getvideosById(_id!),
                            ...
                            child: Stack(
                              children: [
                                Container(
                                    ...
                                    child: VideoController2(
                                        vid: link +
                                "/uploads/${snapshot.data![index].video}", play: false,)),
                                Positioned(
                                  right: 0,
                                  child: IconButton(
                                      onPressed: () {},
