...
class VideoCallRecordScreen extends StatelessWidget {
  const VideoCallRecordScreen({Key? key}) : super(key: key);
                  ...
                  Center(
                    child: Column(
                      children: [
                        ...
                        Icon(Icons.video_call_outlined, color: Colors.green, size: 35,),
